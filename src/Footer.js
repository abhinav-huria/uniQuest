    ...
    <div>
      <div class="container items-center ">
        <footer class="text-blueGray-700 transition duration-500 ease-in-out transform bg-white border rounded-lg ">
          ...
          <div class="w-full px-8 rounded-b-lg bg-blueGray-50">
            <div class="container inline-flex flex-col flex-wrap items-center px-5 py-4 mx-auto sm:flex-row">
              <p class="mx-auto text-sm text-center text-black sm:text-left font-bold">
               Made with ❤ by Team Jarvis's Javalins
              </p>
            </div>
          </div>
        </footer>
